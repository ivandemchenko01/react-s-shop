    ...
    <header className="d-flex justify-between align-center p-40">
      ...
      <ul className="d-flex">
        <li className="cu-p " onClick={props.onClickCart}>
          <img width={18} height={18} src="/img/cart.svg" className="mr-10" /><span>35 USD</span>
        </li>
        <li className="cu-p ">
          <Link to="/favorites">
          <img width={18} height={18} src="/img/heart-icon.svg" /><span>Favorites</span>
          </Link>
        </li>
        <li className="cu-p">
          <Link to="/profile">
          <img width={18} height={18} src="/img/user.svg" /> Profile
          </Link>
        </li>
      </ul>
    </header>
